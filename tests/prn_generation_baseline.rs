use gnss_rust::constants::{
    SIGNAL_INDEX_B1C, SIGNAL_INDEX_B1I, SIGNAL_INDEX_B2A, SIGNAL_INDEX_B2B, SIGNAL_INDEX_B2I,
    SIGNAL_INDEX_B3I, SIGNAL_INDEX_E1, SIGNAL_INDEX_E5A, SIGNAL_INDEX_E5B, SIGNAL_INDEX_E6,
    SIGNAL_INDEX_G1, SIGNAL_INDEX_G3, SIGNAL_INDEX_L1C, SIGNAL_INDEX_L1CA, SIGNAL_INDEX_L2C,
    SIGNAL_INDEX_L2P, SIGNAL_INDEX_L5,
};
use gnss_rust::prngenerate::{
    PrnGenerate, PRN_ATTRIBUTE_BOC, PRN_ATTRIBUTE_CBOC, PRN_ATTRIBUTE_QMBOC, PRN_ATTRIBUTE_TMD,
};
...
fn supported_signal_codes_have_expected_lengths_attributes_and_binary_chips() {
    let cases = [
        ...
        SignalCase {
            name: "GPS L2C",
            system: GnssSystem::GpsSystem,
            signal_index: SIGNAL_INDEX_L2C,
            svid: 13,
            data_len: 10230,
            pilot_len: Some(10230 * 75),
            chip_rate: 1023,
            data_period: 20,
            pilot_period: 1500,
            required_attributes: PRN_ATTRIBUTE_TMD,
        },
        SignalCase {
            name: "GPS L2P",
            system: GnssSystem::GpsSystem,
            signal_index: SIGNAL_INDEX_L2P,
            svid: 17,
            data_len: 10230 * 2,
            pilot_len: None,
            chip_rate: 10230,
