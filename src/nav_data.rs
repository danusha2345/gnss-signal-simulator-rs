...
impl NavData {
    ...
    pub fn set_ephemeris(&mut self, svid: i32, eph: &GpsEphemeris) -> i32 {
        match self {
            ...
            NavData::BCNav1(nav) => if nav.set_ephemeris(svid, eph) { 1 } else { 0 },
            NavData::BCNav2(nav) => nav.set_ephemeris(svid, eph), // Возвращает i32
            NavData::BCNav3(nav) => if nav.set_ephemeris(svid, eph) { 1 } else { 0 },
        }
    }
    ...
    pub fn set_almanac(&mut self, alm: &[GpsAlmanac]) -> i32 {
        match self {
            ...
            NavData::BCNav1(nav) => if nav.set_almanac(alm) { 1 } else { 0 },
            NavData::BCNav2(nav) => nav.set_almanac(alm), // Возвращает i32
            NavData::BCNav3(nav) => if nav.set_almanac(alm) { 1 } else { 0 },
        }
    }
    ...
    pub fn set_iono_utc(
        ...
        match self {
            ...
            NavData::BCNav3(nav) => if nav.set_iono_utc(iono_param, utc_param) { 1 } else { 0 },
        }
    }
