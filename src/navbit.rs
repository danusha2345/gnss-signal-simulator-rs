...
impl NavBit {
    ...
    pub fn unscale_long(value: f64, scale: i32) -> i64 {
        unsafe {
            ...
            if sign { -(fraction as i64) } else { fraction as i64 }
        }
    }
    ...
    pub fn unscale_ulong(value: f64, scale: i32) -> u64 {
        unsafe {
            ...
            let mut fraction = std::mem::transmute::<f64, u64>(data.d_data);
    ...
    pub fn crc24q_encode(bit_stream: &[u32], length: i32) -> u32 {
        ...
        for i in 0..byte_num {
            crc_result = (crc_result << 8) ^ Self::CRC24Q[((data >> 24) ^ (crc_result >> 16)) as usize];
            data <<= 8;
            if (i & 3) == 3 { // move to next word
